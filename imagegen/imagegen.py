...
def genDeltaStatImage(oldstat, newstat, winsR, lossesR, playtime, lbsize, season):
    ...
    img = sctext(img, (1441, 315, 1731, 373), "font.ttf", "W/L:", 62, (255, 255, 255), 6, (0, 0, 0))
    img = sctext(img, (1441, 401, 1731, 538), "font.ttf", str(round(winsR/max(1, lossesR), 2)), 180, (255, 255, 255), 9, (0, 0, 0))
